...
class ImageSprite extends Evented {
    ...
    constructor(base: string, eventedParent?: Evented, transformRequestCallback?: Function) {
        ...
        const jsonRequest = transformRequestCallback ? transformRequestCallback(url, ajax.ResourceType.SpriteJSON) : { url };
        ...
        const imageRequest = transformRequestCallback ? transformRequestCallback(url, ajax.ResourceType.SpriteImage) : { url };
